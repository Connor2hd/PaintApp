    ...
    public class ManufacturersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Manufacturer != null ? 
                          ...
                          Problem("Entity set 'PaintContext.Manufacturer'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ManufacturerId,ManufacturerName,ManufacturerDescription,LogoImageURL")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ManufacturerId,ManufacturerName,ManufacturerDescription,LogoImageURL")] Manufacturer manufacturer)
        {
